...
public class AbsoluteFieldDrive extends CommandBase
{
  ...
  public void execute()
  {
    ...
    // Limit velocity to prevent tippy TODO: REIMPLEMENT
    ...
    SmartDashboard.putNumber("Left Stick X", vX.getAsDouble());
    SmartDashboard.putNumber("Left Stick Y", vY.getAsDouble());
